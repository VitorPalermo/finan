												...
												<table id="example" class="table table-bordered table-hover display" style="width:100%">
													...
													<tbody>
															...
															<tr>
																...
																<td></td>
																<td></td>
																<td><a role="button" href="images/" class="btn btn-primary" title="Details" target='_blank'><i class="fas fa-file-archive"></i></a></td>


																
																<td>
																	<a role="button" href="" class="btn btn-primary" title="Details" target='_blank'><i class="fas fa-eye"></i></a>
																	<a role="button" href="" class="btn btn-success" title="Payments" target='_blank'><i class="fas fa-money-bill"></i></a>
...
<tr>
	...
	<td><?php echo $paytotal ?></td>
	<td><?php echo $npayments . 'payments' ?></td>
	<td><a role="button" href="images/<?php echo $contract?> " class="btn btn"></a></td>

	<td>
	<a role="button" href="project_detalls.php?code=<?php echo $code ?>"></a>
	<a role="button" href="payments_detalls.php?code=<?php echo $code ?>"></a>
</td>
