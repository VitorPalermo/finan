										...
										<div class="row">
											<div class="col-lg-6">
												<div class="form-group">
													<label>Mail</label>
													<input class="form-control" name="name" type="text" value="<?php echo $mail ?>"  required />
												</div>
											</div>
								...
								<div class="card-body text-center">
									...
									<div class="row">
										<form action="insert_image.php" method="post" enctype="multipart/form-data">
												...
												<div class="form-group">
													<input class="form-control" name="id" type="number" value=" style='display: none' />
													<br>
													<center>
									...
									<div class="row">
										<div class="col-lg-6">
											<div class="form-group">
												...
												<input class="form-control" name="id" type="number" value="<?php echo $password ?>" style='display: none' />
											</div>
										</div>
